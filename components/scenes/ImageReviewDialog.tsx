        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {generation.source === "user_uploaded"
              ? `Uploaded image / ${generation.size}`
              : `${generation.stylePresetName} v${generation.stylePresetVersion} / ${generation.model} / ${generation.quality} / ${generation.size}`}
          </DialogDescription>
        </DialogHeader>
        {generation.imageUrl ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border p-3">
            ...
            <dl className="mt-2 grid grid-cols-[auto_1fr] gap-x-4 gap-y-1 text-xs">
              ...
              {generation.promptTemplateVersion ? (
                <>
              ...
              <dd className="text-right uppercase">
                ...
                {generation.outputCompression !== null
          ...
          {generation.finalPrompt ? (
            ...
            <div className="rounded-xl border p-3">
              ...
              <p className="mt-2 text-xs text-muted-foreground">
                This image was uploaded from a file, not generated by AI.
              </p>
            </div>
          )}
        </div>
