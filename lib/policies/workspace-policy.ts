...
const workspaceCapabilities = {
  owner: {
    ...
    manageStylePresets: true,
    manageCustomVoices: true,
    manageChannelProfiles: true,
    manageSubtitles: true,
    renderVideo: true,
    manageUsage: true,
    viewOperationalReadiness: true,
  ...
  editor: {
    ...
    manageVoicePresets: true,
    manageStylePresets: true,
    manageCustomVoices: false,
    manageChannelProfiles: false,
    manageSubtitles: true,
    renderVideo: true,
    manageUsage: true,
    viewOperationalReadiness: false,
    manageMediaLibrary: true,
    composePosts: true,
    publishPosts: true,
    useMarketingChat: true,
